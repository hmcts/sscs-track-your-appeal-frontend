...
obj.VvQ8RFCwLx = require('./adjourned.json');
obj['1CA27vtZ1z'] = require('./appealReceived.json');
obj.D8dg4cGLHZ = require('./closed.json');
obj['NlWfpNabJ0'] = require('./dormant.json');
obj.ZFEosvLF4N = require('./dwpRespond.json');
obj.aAIlOULP63 = require('./dwpRespondOverdue.json');
obj.akEe9AZ7dt = require('./hearing.json');
...
obj.vUXyPb17L3 = require('./smokeTest.json');
