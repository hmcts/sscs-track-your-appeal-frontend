...
do
    echo "*** Testing $i ***"
    SAUCELABS_BROWSER=$i TUNNEL_IDENTIFIER=sscs-test yarn test:crossbrowser --reporter mochawesome --reporter-options reportFilename="${i}_report",reportDir="${outputDirectory}"
